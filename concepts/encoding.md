...
previous versions, specially for client encoding and signing with Ledger devices. Match does not
...
allows for quick reconstruction of encoded data. Match uses RLP to encode/decode Ethereum
