...
The `x/inflation` module mints new Match tokens and allocates them in daily
epochs according to the [Match Token
Model](https://match.blog/the-match-token-model-edc07014978b) distribution to
...
The allocation of new coins incentivizes specific behaviour in the Match
