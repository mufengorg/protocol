...
The Match Token Model outlines how the Match network is secured through a
...
issue 1 billion Match tokens within the first 4 years.
...
daily provision (`epochProvison`) of Match tokens is minted and allocated to staking rewards,
