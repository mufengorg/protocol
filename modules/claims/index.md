...
This document specifies the internal `x/claims` module of the Match Hub.

The `x/claims` module is part of the Match [Rektdrop](https://match.blog/the-match-rektdrop-abbe931ba823)
...
For the Match Rektdrop, users are required to claim their airdrop by participating in core network activities.
...
* 25% is claimed by using the EVM (deploy or interact with contract, transfer Match through a web3 wallet)
